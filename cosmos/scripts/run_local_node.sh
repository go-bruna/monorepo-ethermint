...
from_scratch () {
  ...
  cp ../sgx/node_config.toml $HOME_DIR/config
  ...
  $BINARY genesis add-genesis-account $KEY 1000000000000000000000000000$DENOM,900test --keyring-backend $KEYRING
  $BINARY genesis add-genesis-account $KEY2 1000000000000000000000000000$DENOM,800test --keyring-backend $KEYRING
