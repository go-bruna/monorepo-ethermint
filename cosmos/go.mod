module github.com/inco-fhevm/inco/cosmos
...
replace (
	...
	// Our fork of ethermint
	// github.com/evmos/ethermint => github.com/inco-fhevm/ethermint v0.0.0-20240415144555-19e194a060f2
